...
namespace RgCidadao.Domain.Queries.Imunizacao
{
    public class CartaoVacinaCommandText : ICartaoVacinaCommand
    {
        ...
        public string sqlGetCartaoVacinaByProduto = $@"SELECT *
                                                       FROM PNI_VACINADOS
                                                       WHERE ID_PRODUTO = @id_produto";
        string ICartaoVacinaCommand.GetCartaoVacinaByProduto { get => sqlGetCartaoVacinaByProduto; }

        public string sqlGetCartaoVacinaByProdutor = $@"SELECT *
                                                        FROM PNI_VACINADOS
                                                        WHERE ID_PRODUTOR = @id_produtor";
        string ICartaoVacinaCommand.GetCartaoVacinaByProdutor { get => sqlGetCartaoVacinaByProdutor; }
    }
}
