...
namespace RgCidadao.Domain.Queries.AtencaoBasica
{
    ...
    {
        public string sqlGetAllPagination = $@"SELECT FIRST(@pagesize) SKIP(@page) ECA.ID, ECA.ID_PROFISSIONAL, M.CSI_NOMMED PROFISSIONAL,PAC.CSI_NOMPAC PACIENTE,
                                                      ECA.DATA_ATENDIMENTO, EE.DESCRICAO EQUIPE
                                               FROM ESUS_CONSUMO_ALIMENTAR ECA
                                               JOIN TSI_MEDICOS M ON M.CSI_CODMED = ECA.ID_PROFISSIONAL
                                               JOIN TSI_CADPAC PAC ON PAC.CSI_CODPAC = ECA.ID_CIDADAO
                                               LEFT JOIN ESUS_EQUIPES EE ON EE.ID = ECA.ID_EQUIPE
                                               @filtro
                                               ORDER BY ECA.ID DESC";
        string IConsumoAlimentarCommand.GetAllPagination { get => sqlGetAllPagination; }

        public string sqlGetCountAll = $@"SELECT COUNT(*) FROM (SELECT ECA.ID, ECA.ID_PROFISSIONAL, M.CSI_NOMMED PROFISSIONAL,PAC.CSI_NOMPAC PACIENTE,
                                                                       ECA.DATA_ATENDIMENTO, EE.DESCRICAO EQUIPE
                                                                FROM ESUS_CONSUMO_ALIMENTAR ECA
                                                                JOIN TSI_MEDICOS M ON M.CSI_CODMED = ECA.ID_PROFISSIONAL
                                                                JOIN TSI_CADPAC PAC ON PAC.CSI_CODPAC = ECA.ID_CIDADAO
        ...
        public string sqlInsert = $@"INSERT INTO ESUS_CONSUMO_ALIMENTAR (ID, ID_PROFISSIONAL, DATA_ATENDIMENTO, ID_CIDADAO, NUM_CARTAO_SUS, NOME_CIDADAO,
                                                                         ...
                                                                         FLG_D6A23_FRUTA, FLG_D6A23_FRUTA_QTD, FLG_D6A23_COMIDA_SAL,
                                                                         FLG_D6A23_COMIDA_SAL_QTD, FLG_D6A23_COMIDA_SAL_OFERECIDA, FLG_D6A23_OUTRO_LEITE,
                                                                         FLG_D6A23_MINGAU_LEITE, FLG_D6A23_IORGUTE, FLG_D6A23_LEGUMES, FLG_D6A23_VEGETAL,
                                                                         FLG_D6A23_VERDURA, FLG_D6A23_CARNE, FLG_D6A23_FIGADO, FLG_D6A23_FEIJAO,
                                                                         FLG_D6A23_ARROZ, FLG_D6A23_HAMBURGUER, FLG_D6A23_BEBIDA_ADOCADA,
                                                                         FLG_D6A23_MACARRAO_INSTANTANEO, FLG_D6A23_BISCOITO_RECHEADO, FLG_M24_REFEICAO_TV,
                                                                         FLG_M24_CAFE_MANHA, FLG_M24_LANCHE_MANHA, FLG_M24_ALMOCO, FLG_M24_LANCHE_TARDE,
                                                                         FLG_M24_JANTAR, FLG_M24_CEIA, FLG_M24_FEIJAO, FLG_M24_FRUTA, FLG_M24_VERDURA,
                                                                         FLG_M24_HAMBURGUER, FLG_M24_BEBIDAS_ADOCADA, FLG_M24_MACARRAO_INSTANTANEO,
                                                                         FLG_M24_BISCOITO_RECHEADO, UUID, DATA_ALTERACAO_SERV, ID_ESUS_EXPORTACAO_ITEM,
                                                                         ID_UNIDADE, ID_USUARIO, ID_EQUIPE, ID_CONTROLE_SINCRONIZACAO_LOTE)
                                     VALUES (@id, @id_profissional, @data_atendimento, @id_cidadao, @num_cartao_sus, @nome_cidadao, @data_nascimento, @sexo,
                                             @local_atendimento, @flg_m6_leite_peito, @flg_m6_mingau, @flg_m6_agua_cha, @flg_m6_leite_vaca,
                                             @flg_m6_formula_infantil, @flg_m6_suco_fruta, @flg_m6_fruta, @flg_m6_comida_sal, @flg_m6_outros_alimentos,
                                             @flg_d6a23_leite_peito, @flg_d6a23_fruta, @flg_d6a23_fruta_qtd, @flg_d6a23_comida_sal, @flg_d6a23_comida_sal_qtd,
                                             @flg_d6a23_comida_sal_oferecida, @flg_d6a23_outro_leite, @flg_d6a23_mingau_leite, @flg_d6a23_iorgute,
                                             @flg_d6a23_legumes, @flg_d6a23_vegetal, @flg_d6a23_verdura, @flg_d6a23_carne, @flg_d6a23_figado, @flg_d6a23_feijao,
                                             @flg_d6a23_arroz, @flg_d6a23_hamburguer, @flg_d6a23_bebida_adocada, @flg_d6a23_macarrao_instantaneo,
                                             @flg_d6a23_biscoito_recheado, @flg_m24_refeicao_tv, @flg_m24_cafe_manha, @flg_m24_lanche_manha, @flg_m24_almoco,
                                             @flg_m24_lanche_tarde, @flg_m24_jantar, @flg_m24_ceia, @flg_m24_feijao, @flg_m24_fruta, @flg_m24_verdura,
                                             @flg_m24_hamburguer, @flg_m24_bebidas_adocada, @flg_m24_macarrao_instantaneo, @flg_m24_biscoito_recheado, @uuid,
                                             @data_alteracao_serv, @id_esus_exportacao_item, @id_unidade, @id_usuario, @id_equipe, @id_controle_sincronizacao_lote)";
        ...
        public string sqlUpdate = $@"UPDATE ESUS_CONSUMO_ALIMENTAR
                                     ...
                                     WHERE ID = @id";
        string IConsumoAlimentarCommand.Update { get => sqlUpdate; }

        public string sqlGetConsumoAlimentarById = $@"SELECT * FROM ESUS_CONSUMO_ALIMENTAR
                                                      WHERE ID = @id";
        string IConsumoAlimentarCommand.GetConsumoAlimentarById { get => sqlGetConsumoAlimentarById; }

        public string sqlDelete = $@"DELETE FROM ESUS_CONSUMO_ALIMENTAR
                                     WHERE ID = @id";
        string IConsumoAlimentarCommand.Delete { get => sqlDelete; }
    }
}
