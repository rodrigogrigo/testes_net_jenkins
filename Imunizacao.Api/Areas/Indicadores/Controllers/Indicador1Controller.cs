...
using RgCidadao.Api.ViewModels.Indicadores.Indicador1;
...
namespace RgCidadao.Api.Areas.Indicadores.Controllers
{
    ...
    [Area("Indicadores")]
    public class Indicador1Controller : ControllerBase
    {
        public IIndicador1Repository _repository;
        private IConfiguration _config;
        public Indicador1Controller(IIndicador1Repository repository, IConfiguration configuration)
        {
        ...
        public ActionResult PublicoAlvo([FromHeader]string ibge, [FromRoute] ParamsRouteIndicador1 model, [FromQuery] ParamsQueryIndicador1 modelquery)
        {
            try
            {
                ...
                foreach (var item in itens)
                {
                    ...
                    else item.qtde_dias_primeiro_atendimento = 0;
                }
        ...
        private string buildSQLFiltros(ParamsQueryIndicador1 modelQuery)
        {
            string sqlFiltros = string.Empty;
