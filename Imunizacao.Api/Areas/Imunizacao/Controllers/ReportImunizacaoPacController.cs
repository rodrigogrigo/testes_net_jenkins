...
namespace RgCidadao.Api.Controllers
{
    ...
    [Area("Imunizacao")]
    public class ReportImunizacaoPacController : ControllerBase//, Syncfusion.EJ.ReportViewer.IReportController
    {
        ...
        public ReportImunizacaoPacController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        //    FileStream reportStream = new FileStream(basePath + @"\Imunizacao.Report\Reports\Imunizacao\ImunizacaoPacienteReport.rdlc", FileMode.Open, FileAccess.Read);
        ...
        //        //INFO PACIENTE
        //        var dtPac = new DataTable();
        //        dtPac.Columns.Add(new DataColumn("profissional", typeof(string)));
        //        dtPac.Columns.Add(new DataColumn("nome_paciente", typeof(string)));
        //        dtPac.Columns.Add(new DataColumn("imunobiologico", typeof(string)));
        //        dtPac.Columns.Add(new DataColumn("idade", typeof(string)));
        //        dtPac.Columns.Add(new DataColumn("id_paciente", typeof(string)));
        //        dtPac.Columns.Add(new DataColumn("dose", typeof(string)));
        //        dtPac.Columns.Add(new DataColumn("data_imunizacao", typeof(string)));
        //        dtPac.Columns.Add(new DataColumn("lote", typeof(string)));

        //        foreach (var item in info)
        //        {
        //            var rowpac = dtPac.NewRow();
        //            int idade = 0;
        ...
        //            dtPac.Rows.Add(rowpac);
        //        }

        //        reportOption.ReportModel.DataSources.Add(new ReportDataSource { Name = "ImunizacaoPaciente", Value = dtCabecalho });
        //        reportOption.ReportModel.DataSources.Add(new ReportDataSource { Name = "ImunobiologicoPaciente", Value = dtPac });
        //    }
        //    catch (Exception ex)
        //    {
        //        throw ex;
