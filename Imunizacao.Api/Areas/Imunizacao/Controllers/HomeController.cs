...
namespace DashboardViewerAspNetCoreDemo_2017.Controllers
{
    ...
    public class StoreSales
    {
        ...
        public static List<StoreSales> GetData(int CustomerID)
        {
            ...
            sales.Add(strSal);
            return sales.Where(t => t.CustomerID == CustomerID).ToList();
        }
    }
