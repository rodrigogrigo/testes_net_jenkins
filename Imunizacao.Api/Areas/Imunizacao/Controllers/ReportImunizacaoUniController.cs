...
namespace RgCidadao.Api.Areas.Imunizacao.Controllers
{
    ...
    [Area("Imunizacao")]
    public class ReportImunizacaoUniController : ControllerBase//, Syncfusion.EJ.ReportViewer.IReportController
    {
        ...
        public ReportImunizacaoUniController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        //    FileStream reportStream = new FileStream(basePath + @"\Imunizacao.Report\Reports\Imunizacao\ImunizacaoUnidadeReport.rdlc", FileMode.Open, FileAccess.Read);
        ...
        //        //INFO Unidade
        //        var dtUni = new DataTable();
        //        dtUni.Columns.Add(new DataColumn("profissional", typeof(string)));
        //        dtUni.Columns.Add(new DataColumn("nome_paciente", typeof(string)));
        //        dtUni.Columns.Add(new DataColumn("imunobiologico", typeof(string)));
        //        dtUni.Columns.Add(new DataColumn("idade", typeof(string)));
        //        dtUni.Columns.Add(new DataColumn("id_paciente", typeof(string)));
        //        dtUni.Columns.Add(new DataColumn("dose", typeof(string)));
        //        dtUni.Columns.Add(new DataColumn("data_imunizacao", typeof(string)));
        //        dtUni.Columns.Add(new DataColumn("lote", typeof(string)));
        //        dtUni.Columns.Add(new DataColumn("nome_unidade", typeof(string)));

        //        foreach (var item in info)
        //        {
        //            var rowpac = dtUni.NewRow();
        //            int idade = 0;
        ...
        //            rowpac["nome_paciente"] = item.paciente;
        ...
        //            rowpac["nome_unidade"] = item.unidade;

        //            dtUni.Rows.Add(rowpac);
        //        }

        //        reportOption.ReportModel.DataSources.Add(new ReportDataSource { Name = "ImunizacaoUnidade", Value = dtCabecalho });
        //        reportOption.ReportModel.DataSources.Add(new ReportDataSource { Name = "ImunobiologicoUnidade", Value = dtUni });
        //    }
        //    catch (Exception ex)
        //    {
        //        throw ex;
