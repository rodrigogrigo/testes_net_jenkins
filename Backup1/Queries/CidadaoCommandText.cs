...
namespace Imunizacao.Domain.Queries
{
    public class CidadaoCommandText : ICidadaoCommand
    {
        ...
        public string GetAllPagination = $@"SELECT FIRST(@pagesize) SKIP(@page) C.CSI_CODPAC, C.CSI_NOMPAC, C.CSI_SEXPAC, C.CSI_DTNASC,
                                                   ...
                                                   C.CSI_PAIPAC, MED.CSI_NOMMED ACS, E.DESCRICAO EQUIPE
                                            FROM TSI_CADPAC C
                                            LEFT JOIN ESUS_CADDOMICILIAR D ON C.ID_ESUS_CADDOMICILIAR = D.ID
        ...
        public string sqlExisteCidadao = $@"SELECT PAC.CSI_CODPAC, PAC.CSI_NOMPAC
                                            FROM TSI_CADPAC PAC
                                                 @filtro";
        ...
        public string SqlCidadaoById = $@"SELECT csi_codpac, CSI_NOMPAC, NOME_SOCIAL, CSI_SEXPAC, CSI_CORPAC, CSI_DTNASC, CSI_CELULAR, NACIONALIDADE, CSI_CODNAT, CSI_NCARTAO,
                                          ...
                                          RESTAURANTE_POPU, DOAC_RESTAURANTE, DOAC_GRUP_RELIG, DOACAO_POPULAR, DOACAO_OUTROS
                                          FROM TSI_CADPAC
                                          WHERE CSI_CODPAC = @csi_codpac";
        ...
        public string sqlInsertCadIndividual = $@"INSERT INTO TSI_CADPAC (CSI_CODPAC, CSI_NOMPAC, NOME_SOCIAL, CSI_SEXPAC, CSI_CORPAC, CSI_DTNASC, CSI_CELULAR,
                                                                           ...
                                                                           DOACAO_POPULAR, EXCLUIDO, DOACAO_OUTROS)
                                                   VALUES (@csi_codpac, @csi_nompac, @nome_social, @csi_sexpac, @csi_corpac, @csi_dtnasc, @csi_celular,
                                                           ...
                                                           @doacao_popular, 'F', @doacao_outros)";
